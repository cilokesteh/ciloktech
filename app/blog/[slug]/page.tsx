...
const contents: Record<string, { body: string[]; keywords: string }> = {
  "alasan-website-umkm-sepi-pengunjung": {
    ...
    body: [
      ...
      "#### Kesimpulan:\nWebsite UMKM yang menghasilkan pelanggan harus: SEO-ready, <1 detik, mobile-first, CTA jelas, dan hosting profesional. Bukan sekadar tampilan menarik. Jika website Anda sepi pengunjung, periksa 5 poin ini terlebih dahulu.",
    ],
  },
  ...
  "kenapa-wordpress-lemot-solusi-nextjs": {
    ...
    body: [
      ...
      "#### Di CilokTech — One-Man Studio:\nSemua project menggunakan Next.js 15. Bukan karena tren, melainkan karena klien saya membutuhkan website yang terbuka <1 detik bahkan di HP dengan spesifikasi rendah.",
    ],
  },
  ...
  "jasa-website-murah-jangan-asal-murah": {
    ...
    body: [
      ...
      "### Biaya sebenarnya\nBulan ke-2 hosting meminta upgrade Rp 300rb/bulan, bulan ke-3 terkena malware Rp 500rb, SEO nol dengan kerugian peluang Rp 2–5jt/bulan, akhirnya harus membuat ulang Rp 1,5jt. Total kerugian Rp 3,5jt + waktu 2 bulan terbuang.",
  ...
  "wordpress-vs-nextjs-untuk-umkm-2026": {
    ...
    body: [
      ...
      "### Benchmark kecepatan (HP entry-level dengan koneksi 4G)\nWordPress Elementor + 15 plugin: LCP 4,2 detik, TTI 6,8 detik, ukuran 3,2MB, skor Lighthouse 62\nNext.js CilokTech One-Man Studio (lab, Lighthouse mobile 4G): LCP 3,0 detik, TBT 0,4 detik, ukuran 136kB, skor Lighthouse 100 (SEO & Aksesibilitas). Di koneksi normal, LCP turun di bawah 1 detik\nWordPress: 40% pengunjung pergi sebelum halaman dimuat. Next.js: konversi +22%.",
      ...
      "### Biaya dalam 1 tahun\nWP murah Rp 500rb: Rp 500rb + Rp 600rb hosting + Rp 500rb perbaikan malware + Rp 1,5jt pembuatan ulang = rugi Rp 4,1jt\nNext.js Rp 1,5jt: all-in sudah termasuk Vercel+domain. Tahun kedua hanya hosting $0–20/bulan. ROI kembali dalam 1 bulan.",
      ...
      "#### Migrasi dari WordPress ke Next.js?\nSaya melakukan migrasi konten WordPress ke Next.js tanpa kehilangan SEO (301 redirect, URL tetap sama). Gratis audit kecepatan — kirim screenshot Lighthouse ke @ciloktech, saya berikan laporan <2 jam.",
    ],
  },
  "template-vs-custom-website": {
    ...
    body: [
      ...
      "### Kenapa custom Rp 1,5jt justru lebih hemat\nCustom = desain + code + SEO + hosting + training, semua untuk bisnis ANDA. Sekali bayar, milik selamanya. Source code 100% di tangan Anda — mau pindah hosting, tambah fitur, atau ganti developer, bebas. Ditambah maintenance gratis 3 bulan dan respon <2 jam langsung ke builder.",
      ...
      "#### Kesimpulan:\nHarga murah itu bukan jaminan hemat. Template 390rb terlihat murah di awal, tapi bayar perpanjangan, desain sama dengan kompetitor, dan SEO nol — itu biaya yang tidak terlihat. Custom Rp 1,5jt: sekali bayar, milik selamanya, tampil beda, dan muncul di Google. Cek perbandingan lengkap di /harga.",
    ],
  },
  "jasa-website-388rb-baca-sebelum-beli": {
    keywords: "jasa website 388rb, jasa pembuatan website murah, website murah 388 ribu, harga website my.id vs com, biaya perpanjangan website, jasa website sewa vs beli",
    body: [
      ...
      "### Rp 388rb itu domain .my.id, bukan .com\nEkstensi .my.id adalah TLD paling murah dan paling jarang dipakai bisnis serius. Begitu Anda minta .com — yang wajar dipakai brand — harganya naik ke sekitar Rp 818rb. Untuk company profile, versi .com bahkan bisa Rp 1,7jt. Jadi 'mulai Rp 388rb' itu harga pancingan untuk iklan, bukan harga yang benar-benar Anda pakai.",
      "### Kuncinya: itu model sewa, bukan beli\nHarga murah di depan adalah loss leader — umpan. Keuntungan penyedia ada di perpanjangan tahunan. Cek sendiri di halaman promo mereka: perpanjangan toko online 'mulai Rp 1,25jt/tahun', bahkan sampai Rp 1,95jt/tahun untuk paket lebih tinggi. Selama Anda mau website tetap online, Anda bayar terus setiap tahun.",
      "### Hitung total biaya 3 tahun — ini angka sebenarnya\nAmbil paket landing .com Rp 818rb sebagai contoh yang wajar:\n- Tahun 1: Rp 818rb (harga promo)\n- Tahun 2: Rp 1,25jt (perpanjangan)\n- Tahun 3: Rp 1,25jt (perpanjangan)\n- Total 3 tahun: sekitar Rp 3,3jt\n\nCilokTech Company Profile:\n- Bayar sekali: Rp 1,5jt\n- Hosting Vercel: gratis\n- Domain: sekitar Rp 150rb/tahun\n- Total 3 tahun: sekitar Rp 1,9jt — dan source code 100% milik Anda\n\nUntuk landing page Rp 900rb, selisihnya makin jomplang. Yang 'murah' justru lebih mahal begitu masuk tahun kedua.",
      "### Kenapa mereka bisa pasang harga segitu\nEmpat alasan teknis, bukan sihir:\n1. Template factory — ganti logo, warna, copy, selesai 4 hari. Bukan desain dari nol, jadi biaya per project rendah.\n2. Shared hosting — ratusan website menumpuk di satu server cPanel murah. Resource dipatok, kecepatan jadi korban.\n3. Anchor pricing — 'harga normal Rp 4,2jt, diskon 65%'. Angka normal itu tidak pernah dipakai jualan; itu trik psikologi.\n4. Profit di renewal — harga awal ditekan serendah mungkin untuk menang di iklan Google, uangnya dikejar dari perpanjangan.",
      "### Yang paling berisiko: source code bukan milik Anda\nDi model sewa, website dan domain menempel ke vendor. Berhenti bayar → website hilang, dan Anda tidak pegang source code untuk pindah. Anda menyewa etalase, bukan memilikinya. Di CilokTech, seluruh source code masuk repository GitHub private milik Anda — mau pindah hosting, tambah fitur, atau ganti developer, semua bebas.",
      "### Kapan jasa website murah masuk akal?\nJujur: kalau Anda cuma butuh kartu nama online sementara, budget benar-benar mepet, dan tidak peduli desain sama dengan bisnis lain — paket sewa .my.id bisa jalan untuk beberapa bulan. Tapi kalau website adalah bagian dari mesin penjualan dan Anda berencana pakai bertahun-tahun, matematika total cost-nya berpihak ke bayar sekali yang jadi milik Anda.",
      "#### Kesimpulan:\nRp 388rb itu harga iklan, bukan harga total. Versi .com + renewal tahunan bikin biaya 3 tahun tembus Rp 3,3jt — lebih mahal dari CilokTech Rp 1,5jt bayar sekali yang source code-nya milik Anda selamanya. Jangan bandingkan harga depan; bandingkan biaya 3 tahun. Rinciannya ada di /harga.",
    ],
  },
};
                ...
                return (
                  <div key={i} className="mt-10 p-5 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-2xl">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <Link href="/harga" className="text-[12px] font-bold bg-gray-900 dark:bg-white text-white dark:text-black px-3 py-1.5 rounded-full hover:bg-black dark:hover:bg-cyan-300 transition">Lihat rincian harga</Link>
                    </div>
                  </div>
                );
              }
