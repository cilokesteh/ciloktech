...
export default function BlogClient() {
  ...
  return (
    <main id="main-content" className="pt-16 bg-white dark:bg-[#0a0a0a] min-h-screen transition-colors duration-300">
      ...
      <section className="py-10 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-gray-500 dark:text-gray-400 mb-6">⭐ {isId ? "Rekomendasi Utama" : "Featured Articles"}</div>
      ...
      <section className="py-10 px-6 bg-[#fafafa] dark:bg-[#111111] border-y border-gray-100 dark:border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-gray-500 dark:text-gray-400 mb-6">{isId ? "Semua Artikel" : "All Articles"}</div>
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-3xl mx-auto bg-gray-900 dark:bg-white rounded-[24px] p-8 md:p-10 text-white dark:text-black">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://t.me/ciloktechcsbot?text=Halo%20CilokTech%2C%20saya%20baru%20membaca%20blog%20dan%20ingin%20konsultasi" className="inline-flex items-center px-7 py-3.5 bg-white dark:bg-black text-gray-900 dark:text-white rounded-full font-bold text-[13.5px] hover:bg-cyan-300 dark:hover:bg-cyan-300 hover:text-black transition">🚀 {isId ? "Mulai Konsultasi" : "Start Consultation"}</a>
