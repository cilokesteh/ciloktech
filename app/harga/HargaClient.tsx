      ...
      <section className="py-20 px-6 bg-white dark:bg-[#0a0a0a] text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="https://t.me/ciloktech?text=Halo%20CilokTech%2C%20mau%20Company%20Profile%20Rp%202.5jt%20(detail%20dari%20/harga)" className="px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-black font-bold rounded-full hover:bg-black dark:hover:bg-cyan-300 transition text-sm">{hp.gasCta}</a>
          </div>
