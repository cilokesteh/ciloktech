  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(180,83,9,0.10) 0%, rgba(120,53,15,0.06) 40%, transparent 70%)",
          top: 0, left: 0,
      ...
      <div
        ref={dotRef}
        aria-hidden
        className="pointer-events-none fixed z-[61] w-2 h-2 rounded-full bg-amber-700/70 dark:bg-amber-400/80 shadow-[0_0_10px_rgba(180,83,9,0.6)]"
        style={{ top: 0, left: 0 }}
      />
    </>
  );
