    ...
    <section className="py-20 md:py-28 bg-gray-950 dark:bg-[#050507] text-white px-6 relative overflow-hidden border-t border-white/[0.06] transition-colors duration-300" id="kontak">
      ...
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-12 text-left max-w-4xl mx-auto">
          ...
          <a href="mailto:hi@ciloktech.my.id?subject=Konsultasi%20Website%20CilokTech" className="group p-6 rounded-[18px] bg-white/[0.06] backdrop-blur border border-white/10 hover:bg-white hover:text-gray-900 transition-all">
            <div className="text-2xl mb-3">📧</div>
