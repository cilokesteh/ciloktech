    ...
    <section ref={sectionRef} className="relative bg-white dark:bg-[#08080b] pt-32 pb-20 md:pt-44 md:pb-28 px-6 overflow-hidden transition-colors duration-300">
      ...
      <div className={`max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <div className="rounded-[24px] border border-gray-200 dark:border-white/10 bg-white dark:bg-[#121217] shadow-[0_24px_70px_rgba(0,0,0,0.1),0_2px_12px_rgba(0,0,0,0.04)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.55)] overflow-hidden hover:shadow-[0_32px_90px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_32px_90px_rgba(0,0,0,0.65)] transition-shadow duration-500">
            ...
            <div className="p-5 md:p-6 space-y-4 bg-[#fcfcfd] dark:bg-[#0e0e12]">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3 hover:border-cyan-300 dark:hover:border-cyan-700 hover:shadow-lg transition-all duration-300"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Revenue</div><div className="text-[18px] font-extrabold mt-1 text-gray-900 dark:text-white">Rp 42.5jt</div><div className="text-[11px] text-emerald-600 font-semibold">+23% ↗</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-lg transition-all duration-300"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Orders</div><div className="text-[18px] font-extrabold mt-1 text-gray-900 dark:text-white">1,248</div><div className="text-[11px] text-emerald-600 font-semibold">+12% ↗</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3 hover:border-cyan-300 dark:hover:border-cyan-700 hover:shadow-lg transition-all duration-300"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Speed</div><div className="text-[18px] font-extrabold mt-1 text-gray-900 dark:text-white">0.8s</div><div className="text-[11px] text-gray-500">LCP</div></div>
              </div>
              <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-4">
                ...
                <div className="flex items-end gap-[5px] h-[72px]">{[30, 45, 25, 60, 55, 80, 65, 90, 70, 85, 60, 95].map((h, i) => (<div key={i} className="flex-1 bg-gradient-to-t from-cyan-600 to-indigo-500 dark:from-cyan-500 dark:to-indigo-400 rounded-t-sm hover:opacity-100 transition-opacity" style={{ height: h + "%", opacity: 0.15 + i * 0.07 }} />))}</div>
              </div>
