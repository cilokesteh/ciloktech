          ...
          <div className="uiverse-card rounded-[24px] border border-gray-200 dark:border-white/10 bg-white dark:bg-[#121217] shadow-[0_24px_70px_rgba(0,0,0,0.1),0_2px_12px_rgba(0,0,0,0.04)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.55)] overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-4 bg-[#fcfcfd] dark:bg-[#0e0e12]">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Discover</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Strategy</div><div className="text-[11px] text-cyan-600 dark:text-cyan-400 font-semibold">Clear direction</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Design</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Custom UI</div><div className="text-[11px] text-indigo-600 dark:text-indigo-400 font-semibold">Built for brand</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Launch</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Ready</div><div className="text-[11px] text-emerald-600 font-semibold">Ready to grow</div></div>
              </div>
