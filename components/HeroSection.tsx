  ...
  return (
    <section className="relative bg-white dark:bg-[#08080b] pt-24 pb-14 md:pt-32 md:pb-20 px-6 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="hero-orb hero-orb-main absolute top-0 left-1/2 -translate-x-1/2 w-[1100px] h-[560px] bg-gradient-to-b from-amber-100/40 dark:from-amber-500/[0.06] to-transparent blur-3xl rounded-full" />
      </div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-12 items-center">
        <div className="space-y-8">
          ...
          >
            <a href="https://t.me/ciloktechcsbot" target="_blank" rel="noopener noreferrer" className="hero-cta uiverse-button px-8 py-4 bg-gray-900 dark:bg-white text-white dark:text-black font-bold rounded-full hover:bg-black dark:hover:bg-amber-600 dark:hover:text-white text-center text-sm shadow-xl shadow-gray-900/20 flex items-center justify-center gap-2 group">
            ...
            <a href="#portofolio" className="hero-cta px-8 py-4 surface-elev text-gray-900 dark:text-white font-bold rounded-full hover:bg-amber-50 dark:hover:bg-amber-950/30 text-center text-sm">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full bg-gray-100 dark:bg-white/[0.06] px-3 py-2 font-semibold text-gray-700 dark:text-gray-300"><span className="h-1.5 w-1.5 rounded-full bg-amber-600" />{t.hero.trusted}</span>
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-gray-100 dark:bg-white/[0.06] px-3 py-2 font-semibold text-gray-700 dark:text-gray-300"><span className="h-1.5 w-1.5 rounded-full bg-stone-600" />{t.hero.noDrama}</span>
          </motion.div>
        </div>
        ...
        >
          <div className="absolute -inset-8 bg-gradient-to-br from-amber-100/40 via-stone-100/30 to-rose-100/30 dark:from-amber-500/8 dark:via-stone-500/4 dark:to-rose-500/8 blur-2xl rounded-[36px] -z-10 animate-pulse" />
          <div className="uiverse-card rounded-[24px] border border-gray-200 dark:border-white/10 bg-white dark:bg-[#121217] shadow-[0_24px_70px_rgba(0,0,0,0.1),0_2px_12px_rgba(0,0,0,0.04)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.55)] overflow-hidden">
            <div className="h-11 bg-gray-50 dark:bg-[#16161c] border-b border-gray-100 dark:border-white/5 flex items-center gap-2 px-4">
              ...
              <div className="ml-4 flex-1 h-6 bg-white dark:bg-[#1c1c24] border border-gray-200 dark:border-white/10 rounded-full flex items-center px-3 text-[11px] text-gray-600 dark:text-gray-400">
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-amber-700 dark:text-amber-400 mr-1.5"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                {t.hero.liveBadge}
              </div>
            </div>
            <div className="p-5 md:p-6 space-y-4 bg-[#fcfcfd] dark:bg-[#0e0e12]">
              <div className="flex items-center justify-between"><div className="h-5 w-28 bg-gray-900 dark:bg-white rounded" /><div className="h-8 w-24 bg-amber-700 dark:bg-amber-500 rounded-full" /></div>
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Discover</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Strategy</div><div className="text-[11px] text-amber-700 dark:text-amber-400 font-semibold">Clear direction</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Design</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Custom UI</div><div className="text-[11px] text-rose-700 dark:text-rose-400 font-semibold">Built for brand</div></div>
                <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-3"><div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Launch</div><div className="text-[14px] font-extrabold mt-1 text-gray-900 dark:text-white">Ready</div><div className="text-[11px] text-amber-800 font-semibold">Ready to grow</div></div>
              </div>
              <div className="bg-white dark:bg-[#16161c] border border-gray-100 dark:border-white/5 rounded-xl p-4">
                ...
                <div className="flex items-end gap-[5px] h-[72px]">{[30, 45, 25, 60, 55, 80, 65, 90, 70, 85, 60, 95].map((h, i) => (<div key={i} className="flex-1 bg-amber-700 dark:bg-amber-500 rounded-t-sm" style={{ height: h + "%", opacity: 0.15 + i * 0.07 }} />))}</div>
              </div>
              <div className="flex gap-2"><div className="h-2 flex-1 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden"><div className="h-full w-[78%] bg-amber-700 dark:bg-amber-500 rounded-full" /></div><span className="text-[10px] font-bold text-gray-600 dark:text-gray-400">from brief to launch</span></div>
            </div>
          </div>
          <div className="absolute -bottom-6 -left-4 bg-white dark:bg-[#16161c] border border-gray-200 dark:border-white/10 rounded-2xl shadow-xl px-4 py-3 flex items-center gap-3 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            <div className="w-9 h-9 bg-amber-700 dark:bg-amber-500 rounded-full flex items-center justify-center text-white text-sm shadow-lg shadow-amber-700/30">✓</div>
