        ...
        <div className="space-y-8">
          ...
          >
            <h1>
              ...
              <br />
              {t.hero.tapi} <span className="relative inline-block"><span className="relative z-10 text-gradient-anim">{t.hero.ngasilinCuan}</span><span className="absolute bottom-1 left-0 right-0 h-3 bg-cyan-100 dark:bg-cyan-900/30 -z-0 rotate-1" /></span>
            </h1>
          </motion.div>
