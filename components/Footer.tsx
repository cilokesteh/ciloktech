  ...
  return (
    <footer className="bg-[#050507] text-gray-400 py-10 px-6 border-t border-white/[0.06] transition-colors duration-300 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-[-40%] left-1/2 -translate-x-1/2 w-[700px] h-[300px] bg-gradient-to-t from-cyan-600/[0.06] to-transparent blur-3xl rounded-full" />
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          <div className="space-y-4 max-w-[340px]">
            <button onClick={handleHomeClick} className="flex items-center gap-2.5 group cursor-pointer text-left" title={`Click: top • Already at top: refresh`}>
              ...
              <div className="flex flex-col leading-none">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-black tracking-widest uppercase bg-white text-black px-2 py-0.5 rounded-full group-hover:bg-cyan-400 transition">.ID</span>
                </div>
            ...
            <div className="inline-flex items-center gap-2 text-[11px] bg-white/5 border border-white/10 px-2.5 py-1 rounded-full hover:bg-white/10 cursor-pointer transition" onClick={handleHomeClick}>
              <span className="w-1.5 h-1.5 bg-cyan-400 rounded-full animate-pulse" /> One-man studio • Senior • 🇮🇩
            </div>
